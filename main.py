...
from controllers import coal_price_controller, komtrax_controller
...
app.include_router(coal_price_controller.router, prefix="/monthly_sales_controllers", tags=["Monthly Sales"])
