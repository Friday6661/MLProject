"""Add table monthly coal price

Revision ID: 8a7018fb0c58
Revises: 6423edab2d88
Create Date: 2024-09-20 13:31:13.616279
...
revision: str = '8a7018fb0c58'
down_revision: Union[str, None] = '6423edab2d88'
...
def downgrade_engine1() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_KOMTRA__3213E83F0B15F44C')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_WEEKLY__3213E83FDA151180')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83F4D3F1BAE')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_MONTHL__3213E83F766E6013')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_MONTHL__3213E83FCABA0494')
    )
...
def downgrade_engine2() -> None:
    ...
    sa.Column('sm_b', sa.VARCHAR(collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.Column('gov_soe', sa.VARCHAR(collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_MONTHL__3213E83F754229F9')
    )
    ...
    sa.Column('aging', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('sm_b', sa.VARCHAR(collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_MONTHL__3213E83F11BEB201')
    )
    ...
    sa.Column('sum_monthly_working_hours', sa.DECIMAL(precision=10, scale=2), autoincrement=False, nullable=True),
    sa.Column('sum_monthly_working_days', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_KOMTRA__3213E83FBF62986D')
    )
    ...
    sa.Column('supplier', sa.VARCHAR(length=100, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.Column('notes', sa.VARCHAR(length=255, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83F62201697')
    )
