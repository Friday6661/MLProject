"""Change column name in M_MonthlyStocks Table

Revision ID: 103823cb55e5
Revises: 231f67239414
Create Date: 2024-08-20 20:31:06.939935
...
revision: str = '103823cb55e5'
down_revision: Union[str, None] = '231f67239414'
...
def downgrade_engine1() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_MONTHL__3213E83FE97DA48C')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83FD8F9AF48')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_KOMTRA__3213E83F9CE2A36D')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_MONTHL__3213E83F08D05C02')
    )
...
def downgrade_engine2() -> None:
    ...
    sa.Column('supplier', sa.VARCHAR(length=100, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.Column('notes', sa.VARCHAR(length=255, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83F31DB44D9')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__T_KOMTRA__3213E83F4C48D3EB')
    )
    ...
    sa.Column('notes', sa.VARCHAR(length=255, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_MONTHL__3213E83F567C41C8')
    )
