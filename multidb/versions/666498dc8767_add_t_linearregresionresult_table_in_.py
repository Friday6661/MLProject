"""Add T_LinearRegresionResult table in clean database

Revision ID: 666498dc8767
Revises: abd20fd4804b
Create Date: 2024-10-09 13:11:24.704955
...
revision: str = '666498dc8767'
down_revision: Union[str, None] = 'abd20fd4804b'
...
def downgrade_engine2() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('T_FORECASTMONTHLYCOALPRICE_M38',
    sa.Column('id', sa.INTEGER(), sa.Identity(always=False, start=1, increment=1), autoincrement=True, nullable=False),
    sa.Column('month', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('coal_price', sa.DECIMAL(precision=10, scale=2), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_FORECA__3213E83F6DA4AB06')
    )
    ...
    op.create_table('T_FORECASTMONTHLYWORKINGHOURS',
    sa.Column('id', sa.INTEGER(), sa.Identity(always=False, start=1, increment=1), autoincrement=True, nullable=False),
    sa.Column('month', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('total_monthly_working_hours', sa.DECIMAL(precision=12, scale=2), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_FORECA__3213E83F675B0FC9')
    )
