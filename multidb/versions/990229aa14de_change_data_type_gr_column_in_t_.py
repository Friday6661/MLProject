"""Change data type gr column in T_MonthlySales

Revision ID: 990229aa14de
Revises: 11fc9f9ba854
Create Date: 2024-08-20 17:53:39.246758
...
revision: str = '990229aa14de'
down_revision: Union[str, None] = '11fc9f9ba854'
...
def downgrade_engine1() -> None:
    ...
    sa.Column('gr', sa.VARCHAR(collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_MONTHL__3213E83F09C74F45')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__M_KOMTRA__3213E83F9EF1C420')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83FFA0E2DCC')
    )
...
def downgrade_engine2() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='PK__T_KOMTRA__3213E83F15D8708B')
    )
    ...
    sa.Column('supplier', sa.VARCHAR(length=100, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.Column('notes', sa.VARCHAR(length=255, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_COALPR__3213E83F256F3C7F')
    )
    ...
    sa.Column('notes', sa.VARCHAR(length=255, collation='SQL_Latin1_General_CP1_CI_AS'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_MONTHL__3213E83FA3EE3FBF')
    )
