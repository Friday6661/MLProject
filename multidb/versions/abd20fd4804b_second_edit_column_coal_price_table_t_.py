"""Second Edit column coal price  table T_FORECASTMONTHLYCOALPRICE_M38

Revision ID: abd20fd4804b
Revises: a049345998d7
Create Date: 2024-10-04 15:24:23.944329
...
revision: str = 'abd20fd4804b'
down_revision: Union[str, None] = 'a049345998d7'
...
def upgrade_engine2() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('T_FORECASTMONTHLYCOALPRICE_M38')
    # ### end Alembic commands ###
...
def downgrade_engine2() -> None:
    ...
    sa.Column('id', sa.INTEGER(), sa.Identity(always=False, start=1, increment=1), autoincrement=True, nullable=False),
    sa.Column('month', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('coal_price', sa.DECIMAL(precision=18, scale=0), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='PK__T_FORECA__3213E83FD74BBCC6')
    )
